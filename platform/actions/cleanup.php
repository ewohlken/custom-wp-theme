...
function start_cleanup() {
    ...
    add_filter('custom_gallery_style', 'custom_gallery_style');

    // additional post related cleaning
    add_filter('get_image_tag_class', 'custom_image_tag_class', 0, 4);
    add_filter('get_image_tag', 'custom_image_editor', 0, 4);
    add_filter( 'the_content', 'custom_img_unautop', 30 );
...
function custom_fixed_img_caption_shortcode($attr, $content = null) {
...
function custom_image_editor($html, $id, $alt, $title) {
...
function custom_img_unautop($pee) {
