 ...
 * @return string
 */
function custom_parent_site($path = '', $echo = true){
...
{
    return custom_parent_site($path, $echo);
}
 ...
 * @return string
 */
function custom_get_image($file = null)
{
 ...
 * @return string
 */
function custom_get_script($file = null, $sub = null)
{
    if(empty($file)) return '';
 ...
 * @return string
 */
function custom_get_stylesheet($file = null){
    if(empty($file)) return '';
 ...
 * @return string
 */
function custom_get_vendor_script($file = null)
{
    return custom_get_script($file, 'vendor');
}
