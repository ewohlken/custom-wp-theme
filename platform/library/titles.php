 ...
 * @return string|void
 */
function custom_get_archive_title($before_title = "", $after_title = "", $no_html = false)
{
    $page_title = '';
    if ($no_html) {
        if (is_category()) {
 ...
 * @return void;
 */
function custom_archive_title($before_title = "", $after_title = "", $no_html = false)
{
    echo custom_get_archive_title($before_title, $after_title, $no_html);
}
 ...
 * @return string
 */
function custom_get_search_title($no_html = false)
{
    global $s;
 ...
 * @return void
 */
function custom_search_title($no_html = false)
{
    echo custom_get_search_title($no_html);
}